...
1. **Explicit argument**:
   - If argument is `.openspec.json` or `pipeline.openspec.json`, read it first and prioritize `outputs.ops_report_md`, then `outputs.performance_report_md`, then `inputs.platform`.
