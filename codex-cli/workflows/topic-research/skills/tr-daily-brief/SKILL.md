...
arguments:
  - name: input
    description: "Daily-brief .openspec.json, topic focus, or pipeline.openspec.json"
---

## Step 1: Upstream Artifact Detection (MANDATORY — before ANY other interaction)

**CRITICAL**: You MUST complete this step BEFORE any other interaction and BEFORE asking the user any questions. Do NOT skip this step.
...
If files found, ask the user: "检测到历史每日简报，是否沿用同主题继续生成？" with files as options.
...
### Step 2.0: Pre-flight — Resolve Paths and Check Environment
...
> **CONSTRAINT**: Do NOT substitute Claude's built-in WebSearch for `news-search` commands. WebSearch may be used as a **supplement** for follow-up queries on specific stories, but the primary data collection MUST go through news-search.
...
### Step 2.2: Filter for AI/ML Relevance
...
**Next step**: Suggest running `tr-brainstorm` to select content topics from this briefing.
