...
description: First-time setup flow for xhs-card preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.content-skills/xhs-card/EXTEND.md` | Current project |
| User | `~/.content-skills/xhs-card/EXTEND.md` | All projects |
