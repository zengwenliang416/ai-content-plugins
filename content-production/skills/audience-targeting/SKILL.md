...
### Step 1: Understand Content Focus
...
### Step 5: Content Strategy per Segment

Map content types to segments:
...
- Audience analysis document with:
  ...
  - Content strategy matrix (segment × content type)
...
- Ask the seller (the account owner) if there are audience types to prioritize or avoid
