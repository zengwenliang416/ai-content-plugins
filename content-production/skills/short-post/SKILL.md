...
### Step 2: Post Structure by Platform
...
- Max 280 characters; punch every word
...
**小红书**
- Title: Eye-catching with emoji, keyword-rich
- Body: Structured with line breaks, emoji headers, and bullet points
- Closing: Tags (#话题 format), question to drive comments

**WeChat**
- Title: Curiosity-gap or benefit-driven
- Body: Subheadings every 2-3 paragraphs, bold key phrases
- Conclusion: Summary + soft CTA

### Step 3: Hook Techniques
