...
1. **Explicit argument**:
   - If argument is `.openspec.json` or `pipeline.openspec.json`, read it first and prioritize `outputs.collab_letter_md`, then `outputs.audience_review_md`, then `inputs.collaborator`.
