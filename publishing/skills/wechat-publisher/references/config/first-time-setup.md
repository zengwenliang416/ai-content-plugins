...
description: First-time setup flow for wechat-publisher preferences
---
...
options:
  - label: "Project (Recommended)"
    description: ".content-skills/ (this project only)"
  - label: "User"
    description: "~/.content-skills/ (all projects)"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.content-skills/wechat-publisher/EXTEND.md` | Current project |
| User | `~/.content-skills/wechat-publisher/EXTEND.md` | All projects |
