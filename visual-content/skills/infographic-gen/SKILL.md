...
```bash
/infographic-gen path/to/content.md
/infographic-gen path/to/content.md --layout hierarchical-layers --style technical-schematic
/infographic-gen path/to/content.md --aspect portrait --lang zh
/infographic-gen  # then paste content
```
