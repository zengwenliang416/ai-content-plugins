...
description: First-time setup flow for knowledge-comic preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.content-skills/knowledge-comic/EXTEND.md` | Current project |
| User | `~/.content-skills/knowledge-comic/EXTEND.md` | All projects |
