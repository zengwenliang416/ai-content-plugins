...
```bash
/knowledge-comic content.md --storyboard-only
```
...
```bash
/knowledge-comic content.md --prompts-only
```
...
```bash
/knowledge-comic comic/topic-slug/ --images-only
```
...
```bash
# Single page
/knowledge-comic comic/topic-slug/ --regenerate 3

# Multiple pages
/knowledge-comic comic/topic-slug/ --regenerate 2,5,8

# Cover page
/knowledge-comic comic/topic-slug/ --regenerate 0
```
