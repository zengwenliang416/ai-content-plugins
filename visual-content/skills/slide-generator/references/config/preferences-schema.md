...
Structure for user preferences in `.content-skills/slide-generator/EXTEND.md`.
...
Then use with: `/slide-generator content.md --style style-name`
...
1. `.content-skills/slide-generator/EXTEND.md` (project)
2. `$HOME/.content-skills/slide-generator/EXTEND.md` (user)
