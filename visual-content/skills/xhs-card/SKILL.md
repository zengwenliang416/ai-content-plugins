...
# Specify style
/xhs-card posts/ai-future/article.md --style notion

# Specify layout
/xhs-card posts/ai-future/article.md --layout dense

# Combine style and layout
/xhs-card posts/ai-future/article.md --style notion --layout list
...
/xhs-card --style bold --layout comparison
[paste content]
```
