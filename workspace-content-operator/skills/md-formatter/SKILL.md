...
Scripts in `scripts/` subdirectory. Use `{baseDir}` as this skill's directory.
...
test -f .content-skills/md-formatter/EXTEND.md && echo "project"

# Then user-level (cross-platform: $HOME works on macOS/Linux/WSL)
test -f "$HOME/.content-skills/md-formatter/EXTEND.md" && echo "user"
```

┌──────────────────────────────────────────────────────────┬───────────────────┐
│ Path │ Location │
├──────────────────────────────────────────────────────────┼───────────────────┤
│ .content-skills/md-formatter/EXTEND.md │ Project directory │
├──────────────────────────────────────────────────────────┼───────────────────┤
│ $HOME/.content-skills/md-formatter/EXTEND.md │ User home │
└──────────────────────────────────────────────────────────┴───────────────────┘
...
```bash
npx -y bun {baseDir}/scripts/main.ts {output-file-path} [options]
```
...
npx -y bun {baseDir}/scripts/main.ts article.md --quotes

# Only fix emphasis issues, skip spacing
npx -y bun {baseDir}/scripts/main.ts article.md --no-spacing

# Disable all processing except frontmatter formatting
npx -y bun {baseDir}/scripts/main.ts article.md --no-spacing --no-emphasis
```
