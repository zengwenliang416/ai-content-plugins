...
**Market and platform data** (24h freshness enforced | `bun {baseDir}/../news-search/scripts/doctor.ts` for status):
- Twitter/X: `bun {baseDir}/../news-search/scripts/search.ts twitter "[topic] trend" 10` — audience sentiment signals
- Reddit: `bun {baseDir}/../news-search/scripts/search.ts reddit "[niche]" 10` — community discussion themes
- Web: `bun {baseDir}/../news-search/scripts/search.ts web "[market topic]" 10` — industry reports and data
