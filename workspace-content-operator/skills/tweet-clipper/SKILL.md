...
```bash
# macOS
cat ~/Library/Application\ Support/content-skills/x-to-markdown/consent.json

# Linux
cat ~/.local/share/content-skills/x-to-markdown/consent.json
```
...
test -f .content-skills/tweet-clipper/EXTEND.md && echo "project"

# Then user-level (cross-platform: $HOME works on macOS/Linux/WSL)
test -f "$HOME/.content-skills/tweet-clipper/EXTEND.md" && echo "user"
```

┌────────────────────────────────────────────────────────────┬───────────────────┐
│ Path │ Location │
├────────────────────────────────────────────────────────────┼───────────────────┤
│ .content-skills/tweet-clipper/EXTEND.md │ Project directory │
├────────────────────────────────────────────────────────────┼───────────────────┤
│ $HOME/.content-skills/tweet-clipper/EXTEND.md │ User home │
└────────────────────────────────────────────────────────────┴───────────────────┘
...
- "User (Recommended)" — ~/.content-skills/ (all projects)
- "Project" — .content-skills/ (this project only)
...
```bash
npx -y bun {baseDir}/scripts/main.ts <url>
npx -y bun {baseDir}/scripts/main.ts <url> -o output.md
npx -y bun {baseDir}/scripts/main.ts <url> --download-media
npx -y bun {baseDir}/scripts/main.ts <url> --json
```
