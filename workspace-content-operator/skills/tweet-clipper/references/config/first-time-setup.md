...
description: First-time setup flow for tweet-clipper preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.content-skills/tweet-clipper/EXTEND.md` | All projects |
| Project | `.content-skills/tweet-clipper/EXTEND.md` | Current project |
