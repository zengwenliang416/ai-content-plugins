...
description: First-time setup flow for cover-generator preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.content-skills/cover-generator/EXTEND.md` | Current project |
| User | `~/.content-skills/cover-generator/EXTEND.md` | All projects |
