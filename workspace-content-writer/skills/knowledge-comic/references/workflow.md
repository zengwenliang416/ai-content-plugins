...
test -f .content-skills/knowledge-comic/EXTEND.md && echo "project"

# Then user-level (cross-platform: $HOME works on macOS/Linux/WSL)
test -f "$HOME/.content-skills/knowledge-comic/EXTEND.md" && echo "user"
```
...
**Strategy A: Using `--ref` parameter** (e.g., ai-image-gen)
...
```bash
npx -y bun {baseDir}/scripts/merge-to-pdf.ts <comic-dir>
```
