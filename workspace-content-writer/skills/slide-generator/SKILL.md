...
```bash
/slide-generator path/to/content.md
/slide-generator path/to/content.md --style sketch-notes
/slide-generator path/to/content.md --audience executives
/slide-generator path/to/content.md --lang zh
/slide-generator path/to/content.md --slides 10
/slide-generator path/to/content.md --outline-only
/slide-generator  # Then paste content
```
...
│                       Path                       │     Location      │
├──────────────────────────────────────────────────┼───────────────────┤
│ .content-skills/slide-generator/EXTEND.md         │ Project directory │
├──────────────────────────────────────────────────┼───────────────────┤
│ $HOME/.content-skills/slide-generator/EXTEND.md   │ User home         │
└──────────────────────────────────────────────────┴───────────────────┘
...
```bash
npx -y bun {baseDir}/scripts/merge-to-pptx.ts <slide-deck-dir>
npx -y bun {baseDir}/scripts/merge-to-pdf.ts <slide-deck-dir>
```
...
```bash
/slide-generator content.md --prompts-only
```
...
```bash
/slide-generator slide-deck/topic-slug/ --images-only
```
...
```bash
# Single slide
/slide-generator slide-deck/topic-slug/ --regenerate 3

# Multiple slides
/slide-generator slide-deck/topic-slug/ --regenerate 2,5,8
```
...
2. Run: `/slide-generator <dir> --regenerate N`
